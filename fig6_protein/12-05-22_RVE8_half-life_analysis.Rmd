...
Constraining deg rate to be positive and using zt_scaled data.      
...
priors1 <- c(prior(normal(0.98, 0.5), nlpar = "N0", coef = "Intercept"), #prior = mean
             ...
             prior(normal(0, 1),nlpar = "k", lb = 0), #uninformative prior for rate
...
In constant red light, ZT19 deg rate is significantly different from ZT7 deg rate.   
...
In constant darkness, ZT19 deg rate is significantly different from ZT7 deg rate.   
